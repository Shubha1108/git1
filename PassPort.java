class PassPort {
    public static String userRegistration(String location, String area, String firstName, String lastName, String birthDate, String email, String userId, String password, String confirmPassword, String securityQuestion, String securityAnswer, String captcha) {
        String result = null;
        boolean isValid = validateUserProfile(location, area, firstName, lastName, birthDate, email,  userId, password, confirmPassword, securityQuestion, securityAnswer, captcha);
    ...
    public static boolean validateUserProfile(String location, String area, String firstName, String lastName, String birthDate, String email, String userId, String password, String confirmPassword, String securityQuestion, String securityAnswer, String captcha) {
